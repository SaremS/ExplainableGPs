# -*- coding: utf-8 -*-
using Distributions, DistributionsAD, LinearAlgebra, KernelFunctions, BlockDiagonals, MLDatasets, Zygote, LinearAlgebra, Flux, Functors
...
Functors.@functor ClassifierSVGPG
